...
Dans différents cadres, la fraude est existante. Une façon répandue pour commettre une fraude est de modifier des chiffres de données de façon à ce que désire l'escroc. 
...
\underline{Mots-clés:} 
Loi de Newcomb-Benford,$1^{er}$ chiffre significatif, Tests d'hypothéses, Risque d'erreur
...
Pour construire une tactique de test lisse et de donner l'expression des statistiques de test, il existe deux théorèmes essentiels qui permettent de construire une famille pour l'hypothèse nulle $H_{0}: X \sim f(.)$ où $f(.)$ est la densité de la loi de Newcomb-Benford et comme tous les moments de cette loi existent nous pouvons utiliser les polynômes pour déterminer les fonctions orthonormales. Un des théorème est connu par Boulerice et Ducharme en 1997.
