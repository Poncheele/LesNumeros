...
\underline{Mots-clés} : Loi de Newcomb-Benford, $1^{er}$ chiffre significatif, Test d'hypothèse, Hypothèse nulle/alternative, Risque d'erreur, Test d'adéquation, Test du khi-deux, Test lisse, p-value.
...
&nbsp;
Le test de Freedman peut être adaptée à des données discrètes, il permet de comparer la distribution du premier chiffre significatif d'un échantillon de données avec la distribution de Benford et ainsi affirmer si les données sont conformes à la loi de Newcomb-Benford.  
...
cas covid:
JUNYI ZHAN (2020) "*Testing Case Number of Coronavirus Disease 2019 in China with Newcomb-Benford Law*" https://arxiv.org/abs/2002.05695
