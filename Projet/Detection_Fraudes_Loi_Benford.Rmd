...
```{r histogramme_AMPM,fig.align='center'}
...
```{r histogramme_journal,fig.align='center'}
knitr::include_graphics("Images/histogramme_journalLESECHOS.png")
```
...
```{r histogramme_pop,fig.align='center'}
knitr::include_graphics("Images/histogramme_populationfrancaise.png")
```
...
```{r histogramme_velos,fig.align='center'}
knitr::include_graphics("Images/histogramme_velos.png")
```
